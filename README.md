...
Yet Another Video Player (or AndroidVideoPlayer) is a Video Player for Android that is based on Googles [ExoPlayer](https://github.com/google/ExoPlayer).
<br/><br/>
...
## Who Is AndroidVideoPlayer For?
First off, AndroidVideoPlayer is not meant to compete with any of the big players like __VLC__ or __MX Player__. <br/>
<br/>
With that out of the way, here are some reasons you might want to consider using AndroidVideoPlayer:

* AndroidVideoPlayer is fully __Open Source__
	* The source code of AndroidVideoPlayer and all libraries is open source and can be found [here](#used-librarys)
* AndroidVideoPlayer __will (and cannot)__ spy on your data
	* Take a look [here](#what-permissions-does-AndroidVideoPlayer-use) to see what permissions AndroidVideoPlayer uses
* AndroidVideoPlayer is __completely free and without ads__
* AndroidVideoPlayer does __not__ include any Trackers
* AndroidVideoPlayer now has a media picker
* AndroidVideoPlayer will play most __Video and Audio Files and Streams__
...
* AndroidVideoPlayer requires at least __Android 7.0 (Nougat)__
...
* While Anime4K really is great at making Anime look great, it is also outstandingly eager to drain your battery
	...
	* But don't worry, __AndroidVideoPlayer__ will warn you when your battery is running out of charge (if enabled)
* AndroidVideoPlayer is my very first Android App and my first (public) project on Github
	* If I'm doing something wrong, please feel free to let me know :)
	
## Anime Specific Features
I personally use AndroidVideoPlayer to watch Anime. As a result of this, it has some features specifically built with Anime in mind.
...
* __Skip Anime Openings__ with the click of a button
	* Skip that super annoying opening with AndroidVideoPlayer's advanced seeking technology
* __More to come__
<!-- TODO: add more features :P -->

## FAQ

#### How Do I Play Videos using AndroidVideoPlayer?
Simply open AndroidVideoPlayer and select a video from the media browser.
Additionally, you can also open a video file in another app (eg. the Gallery app) and Android will ask you what video player to use. Simply select AndroidVideoPlayer and your video will start playing.
In addition to this, you can also share the video with AndroidVideoPlayer. In the Share menu, there will be a entry called __Play with AndroidVideoPlayer.__
...
#### Will AndroidVideoPlayer Stay Ad- Free?
99% Yes. Although Exoplayer supports adding Ads into Videos, I don't feel like this is something I'd like to do.

#### Does AndroidVideoPlayer Use Trackers?
Nope.

#### How does AndroidVideoPlayer Scale up Anime?
When enabled in the Quick Settings menu, AndroidVideoPlayer will use [__bloc97's Anime4K__](https://github.com/bloc97/Anime4K/) for upscaling and enhancing Anime.
...
## What Permissions Does AndroidVideoPlayer Use?
Obviously, AndroidVideoPlayer cannot function without having __any__ permissions.<br/>
These are all permissions that AndroidVideoPlayer uses:
...
* [__REQUEST_INSTALL_PACKAGES__](https://developer.android.com/reference/android/Manifest.permission#REQUEST_INSTALL_PACKAGES)
	* This might sound scary, but it only means that AndroidVideoPlayer is allowed to __ask__ you to install new apps (a new screen will open for you to confirm the installation)
	* This is used to install app updates
	
As you can see, AndroidVideoPlayer cannot access any of your private information (for example [__READ_CONTACTS__](https://developer.android.com/reference/android/Manifest.permission#READ_CONTACTS)).
