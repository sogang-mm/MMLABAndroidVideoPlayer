package kr.ac.sogang.mmlab.AndroidVideoPlayer.ui.mediapicker.chooser;
...
import kr.ac.sogang.mmlab.AndroidVideoPlayer.ui.LaunchActivity;
import kr.ac.sogang.mmlab.AndroidVideoPlayer.util.Logging;

/**
 * Fragment that shows {@link kr.ac.sogang.mmlab.AndroidVideoPlayer.ui.mediapicker.views.MediaCardView} for each media element on the device that matches the MediaKind given.
...
public class MediaChooserFragment extends Fragment implements RecyclerMediaEntryAdapter.CardClickListener
{
    ...
    private void requestStoragePermissions()
    {
        ...
        //request permissions
        requestPermissions(new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, ID_REQUEST_EXT_STORAGE_PERMISSIONS_AND_RELOAD_MEDIA);
    }
