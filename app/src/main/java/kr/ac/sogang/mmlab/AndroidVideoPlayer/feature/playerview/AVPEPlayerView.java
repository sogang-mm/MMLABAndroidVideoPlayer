 ...
 * Does the same as {@link AVPPlayerView}, but with GL
 */
public class AVPEPlayerView extends EPlayerView
{
    /**
    ...
    //region Constructors
    public AVPEPlayerView(Context context)
    {
        this(context, null);
    }

    public AVPEPlayerView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    /**
     * set the scale type to use.
     * Deprecated, use {@link AVPEPlayerView#setPlayerScaleType(PlayerScaleType)} instead.
     *
