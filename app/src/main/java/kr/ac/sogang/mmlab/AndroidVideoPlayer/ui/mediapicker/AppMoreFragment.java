...
import kr.ac.sogang.mmlab.AndroidVideoPlayer.ui.PlayerDebugActivity;
...
public class AppMoreFragment extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        //register click listener for "debug AndroidVideoPlayer" button and hide the button if not a debug build
    ...
    public void onClick(View view)
    {
        ...
        switch (view.getId())
        {
            ...
            {
                //debug AndroidVideoPlayer button was clicked
    ...
    /**
     * Uses a {@link kr.ac.sogang.mmlab.AndroidVideoPlayer.feature.update.AppUpdateManager} to check for updates manually
     */
