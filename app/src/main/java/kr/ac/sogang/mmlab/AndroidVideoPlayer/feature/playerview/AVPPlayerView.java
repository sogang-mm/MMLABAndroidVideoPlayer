package kr.ac.sogang.mmlab.AndroidVideoPlayer.feature.playerview;
 ...
 * Does the same as {@link AVPEPlayerView}, but without GL
 */
public class AVPPlayerView extends PlayerView implements VideoListener
{
    /**
    ...
    public AVPPlayerView(Context context)
    {
        this(context, null);
    }

    public AVPPlayerView(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public AVPPlayerView(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    /**
     * Deprecated. use {@link AVPPlayerView#setSimplePlayer(SimpleExoPlayer)} instead!
     */
    @Override
    @Deprecated
